...
-- -------------------------------
-- バッファ移動
vim.keymap.set('n', 'H', ':bprevious<CR>')  -- 前のバッファへ
vim.keymap.set('n', 'L', ':bnext<CR>')      -- 次のバッファへ
-- リーダーキーをスペースに設定
vim.g.mapleader = ' '
...
vim.keymap.set('n', '<leader>e', function()
  ...
  local dir = (file == '' and vim.fn.getcwd() or vim.fn.expand('%:h'))
  vim.cmd('edit ' .. dir)
end, { desc = 'Open current file directory or CWD' })
